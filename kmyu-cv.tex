...
\begin{bibenum}
    \item Yu, Kristine M. (accepted) The role of time in phonetic
...
\begin{bibenum}
    ...
    \item Yu, Kristine M. (under revision). Tonal marking of absolutive case
...
\begin{bibenum}
    ...
    \item Yu, Kristine M and Deniz Ozyildiz. (in prep) The emergence of
      ...
      \item Yu, Kristine M. (in prep). Prosodic parsing for
        minimalism. \emph{Minimalist Parsing}. Oxford University Press.
\end{bibenum}
...
\begin{bibenum}
    ...
    \item \textbf{Yu, Kristine M.} and Deniz
      ...
      Meeting of the Berkeley Linguistic Society}. [\href{http://linguistics.berkeley.edu/bls/previous_proceedings/bls42.pdf}{web}]
...
\item Yu, Krisitne M. (2017). Parsing with prosody: towards a computational model of prosodically-informed syntactic parsing in Samoan
. Brown University, Department of
  Cognitive, Linguistic, and Psychological Sciences. LingLangLunch
  series. April 19, 2017.  
\item Yu, Kristine M. (2017). Towards a model of the syntax-prosody interface in Samoan. Yale University, Department of
  Linguistics Colloquium Series. January 23, 2017.
  ...
  \item Yu, Kristine. (2016). Prosodic constituency in Samoan. Workshop on the Effects of
    Constituency on Sentence Phonology. University of Massachusetts
...
\begin{innerlist}
    \item Kusmer, Leland (in progress). 
    \item Hauser, Ivy (in progress). Co-chair.
...
\textbf{Undergraduate honors theses} \hfill 
\begin{innerlist}
    \item Higgins, Valerie (in progress).
\end{innerlist}
...
\item[] \textit{Instructor}%
    ...
    \begin{innerlist}
        ...
        \begin{innerlist}[\enskip$\circ$,leftmargin=*]
            \item Fall~2015, Fall~2016, Fall~2017
        \end{innerlist}
...
\textbf{Conference organization}
    ...
    \item Co-organizer, Experimental and Theoretical Approaches to
      Prosody IV. 2017 -- 2018.
...
\item Linguistics at the Five Colleges Facebook group co-creator and administrator, 2016 -- present \href{https://www.facebook.com/groups/ling5}{webpage}.
\end{innerlist}
