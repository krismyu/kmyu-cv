...
\rfoot{{\footnotesize (commit \gitAbbrevHash, \,\gitAuthorIsoDate)}\hspace{\marginparwidth}}
    ...
    \begin{innerlist}
        \item Affiliations:
            \begin{innerlist}[\enskip$\circ$,leftmargin=*]
                \item \href{http://blogs.umass.edu/icesl/}{Institute for Computational and Experimental Study of Language}
...
\begin{innerlist}
    ...
    \item[] \href{http://ling.umd.edu/}{Department of Linguistics},
            \href{http://www.umd.edu}{University of Maryland College Park}
...
\begin{bibsection}
    ...
    \item Andrew Mellon Foundation / Center for Teaching \& Faculty
      ...
      Colleges Prosody Community'', \$10,000, 2013 -- 2014.
        ...
        \item Winter prosody bootcamp: January 17-18, 2014
        \item UMass Tone Workshop: June 2-3, 2014
        \end{innerlist}
...
\begin{bibenum}
    ...
    \item Yu, Kristine M. and Hiu Wai Lam. (2014). The role of
    ...
    \item Yu, Kristine M. (To appear). The experimental state of mind in
      elicitation: illustrations from tonal fieldwork. \emph{Language Documentation \&
        Conservation}. 
      [\href{http://www.krisyu.org/static/pages/output/kiy-xrefs.pdf}{manuscript},
      \href{http://www.krisyu.org/blog/posts/2013/06/ldc-kiy-overview/}{supplementary materials}]

    \item Zuraw, Kie, Yu, Kristine M., and Robyn Orfitelli. (2014). The word-level prosody of
...
\restartlist{bibenum}
\begin{bibenum}
    \item Kuo, Grace C.-H. and Kristine M.~Yu. (2012). Taiwan Mandarin
...
\item Yu, Kristine M., Khan, Sameer ud Dowla, and Sundara,
  Megha. (2014). Intonational phonology in Bengali and English
  infant-directed speech. Speech Prosody 2014.
...
\item Kristine M.~Yu, Sameer ud Dowla Khan, Alejandrina Cristia, Huei-Mei
Liu, Megha Sundara (2011). \href{http://www.acoustics.org/press/162nd/Yu_5aSCa3.html}{The
  joint purpose of pitch patterns in "motherese": drawing attention
  and conveying language structure.} ASA Lay Language Papers 162nd Acoustical Society of America Meeting. 
...
\item Yu, Kristine M., Sameer ud Dowla Khan and Megha
  ...
  \item Zuraw, Kie, Orfitelli, Robyn, and Kristine
...
\item Khan, Sameer ud Dowla and Kristine M. Yu. (2014). Intonational phonology
  in infant-directed speech. Linguistics Society of America, Minneapolis, MN.

\item Silverstein, Kate and Kristine M. Yu. (2013). Investigating
...
\begin{innerlist}
    ...
    \item Pizzo, Presley (in progress).
\end{innerlist}

\halfblankline

\textbf{Generals paper committees} \hfill 

\begin{innerlist}
    \item Conner, Tracy (in progress).
    \item Fainleib, Yelena (in progress).
    ...
    \item Moore-Cantwell, Claire (2012). \emph{Syntactic probability influences duration}.
\end{innerlist}
...
\item[] \textit{Instructor}%
    ...
    \begin{innerlist}
        ...
        \item \href{http://www.umass.edu/linguist/courses/detail.php?cid=627}{LINGUIST~592B}:
...
\href{http://www.umass.edu}{\textbf{University of California Los Angeles}},
Los Angeles, CA
\begin{outerlist}

\item[] \textit{Instructor / course designer}%
    \hfill \textbf{January 2009 -- June 2010}
    \begin{innerlist}
        \item LING 254A/B: Quantitative methods in linguistics (Graduate)
        \begin{innerlist}[\enskip$\circ$,leftmargin=*]
            \item Winter~2010 
            \item Winter~2009 (with Megha Sundara and Kie Zuraw;
              Statistics and R practicum)
        \end{innerlist}
    \end{innerlist}

\item[] \textit{Teaching Assistant}%
    \hfill \textbf{March 2009 -- December 2010}
    \begin{innerlist}
        \item LING 104: Experimental phonetics (Undergraduate)
        \begin{innerlist}[\enskip$\circ$,leftmargin=*]
            \item Fall~2010 (with Sun-Ah Jun)
        \end{innerlist}
        \item Honors Collegium 56: Language as a window to the mind (Undergraduate)
        \begin{innerlist}[\enskip$\circ$,leftmargin=*]
            \item Spring~2009 (with Susie Curtiss)
        \end{innerlist}
    \end{innerlist}
...
\begin{outerlist}
    ...
    \item[] \textit{Conferences}%
      ...
      \begin{innerlist}
      \item \emph{2014 Joint Meeting of SIGMORPHON and SIGFSM},
...
\item Cognitive Science Society (2010 -- present)
\end{innerlist}

\section{Departmental service}

\begin{innerlist}
  \item Library liaison, 2013 -- 2014
