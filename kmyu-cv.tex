...
\item Yu, Kristine M. (To appear). Advantages of constituency: computational perspectives on word prosody in Samoan. \emph{Proceedings of the 22nd Conference on Formal Grammar (FG 2017)}. %[\href{http://www.krisyu.org/pages/pdfs/yukhansundara2014.pdf}{pdf}]
...
\begin{bibenum}
    ...
    \item Yu, Kristine M and Deniz \"{O}zy\i{}ld\i{}z. (in prep) The emergence of
...
\begin{innerlist}
    \item Kusmer, Leland (in progress). Co-chair.
