...
\begin{bibenum}
    ...
    \item Yu, Kristine M. and Hiu Wai Lam. (Under review). The role of
      creaky voice in Cantonese tone perception.

    \item Yu, Kristine M. (Accepted). The experimental state of mind in
      elicitation: illustrations from tonal fieldwork. \emph{Language Documentation \&
        Conservation}. 
      [\href{http://www.krisyu.org/static/pages/output/kiy-rev.pdf}{manuscript},
...
\begin{outerlist}
    ...
    \item[] \textit{Journals}%
      ...
      \begin{innerlist}
      \item \ref{http://www.journals.elsevier.com/lingua/}{\emph{Lingua}}, 2013 -- 2014
        \item
