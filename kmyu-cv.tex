...
\begin{innerlist}
    \item Kusmer, Leland (2019). Co-chair (with Kyle Johnson).
    \item Hauser, Ivy (2019). Co-chair (with John Kingston).
\end{innerlist}
...
\begin{innerlist}
    \item \"{O}zy\i{}ld\i{}z, Deniz (2021).
    \item Mullin, Kevin (2012-2017).
    \item S\'anchez Alvarado, Covadonga (2019).
...
\begin{innerlist}
%  \item Kugemoto, Mari (in progress). 
%  \item Ren, Jia (in progress).
