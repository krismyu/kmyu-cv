...
\restartlist{bibenum}
\begin{bibenum}
\item Yu, Kristine M. (under revision). Samoan intonation and challenges for {A}utosegmental-{M}etrical {T}eory. In \emph{Prosodic Typology III}.
  
\item Lu, Yu-An and Kristine M. Yu (To appear). Formosan Phonetics. In \emph{Handbook on Formosan Linguistics}. Leiden: Brill.
...
\item Yu, Kristine M. (2021). Representations for multiple dependencies in prosodic structures. Special Session of 18th Inernational Conference on Natural Language Processing: Representation of speech, articulatory dynamics, prosody and language in layers. National Institute of Technology Silchar, India (virtual). December 19, 2021.
...
\begin{innerlist}
\item L{\'o}pez-Barrios, Wilmar (2023). \emph{Language-specific intonation in the bilingual Palenquero/Spanish speakers: A prosodic transition between two generations}. 
...
\item Gender Equity in Linguistics committee, 2019 -- present
